...
void UpdateSMCState(int idx)
{
   ...
   // Get 1H POI (Recent Swing High/Low)
   double poiHigh = iHigh(symbol, PERIOD_H1, 1);
   double poiLow  = iLow(symbol, PERIOD_H1, 1);
   ...
   {
      double prev5mHigh = iHigh(symbol, PERIOD_M5, 1);
      double prev5mLow  = iLow(symbol, PERIOD_M5, 1);
