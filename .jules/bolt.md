...
## 2026-05-31 - Pandas overhead on micro-datasets
**Learning:** For small datasets (e.g., 15 candles), Pandas SMA calculation is over 170x slower than a native Python implementation. The overhead of DataFrame creation and rolling window logic is massive compared to simple list operations.
**Action:** Always prefer native Python for simple technical indicators when the lookback period is small and data volume is low.
