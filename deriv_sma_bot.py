...
async def trade_logic(api, symbol):
    ...
    try:
        ...
        while True:
            ...
            # Initial history from subscription
            if 'candles' in candle_data:
                ...
                if last_processed_epoch[symbol] == 0:
                    last_processed_epoch[symbol] = current_candle_epoch
            ...
            if 'ohlc' in candle_data:
                ...
                if open_time > current_candle_epoch:
                    ...
                    if len(candle_history) > SMA_SLOW + 20:
                ...
                # Check for crossover on new candle start
